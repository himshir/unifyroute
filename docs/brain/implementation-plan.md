...
#### [MODIFY] [adapters.py](file:///home/himanshu/code/llmway/router/src/router/adapters.py)
...
#### [MODIFY] [main.py](file:///home/himanshu/code/llmway/api-gateway/src/api_gateway/main.py)
...
#### [NEW] [brain/pyproject.toml](file:///home/himanshu/code/llmway/brain/pyproject.toml)

Standard Python package, depends on `shared`, `httpx`, `pydantic`.

---

#### [NEW] [brain/src/brain/config.py](file:///home/himanshu/code/llmway/brain/src/brain/config.py)
...
#### [NEW] [brain/src/brain/health.py](file:///home/himanshu/code/llmway/brain/src/brain/health.py)
...
#### [NEW] [brain/src/brain/importer.py](file:///home/himanshu/code/llmway/brain/src/brain/importer.py)
...
#### [NEW] [brain/src/brain/tester.py](file:///home/himanshu/code/llmway/brain/src/brain/tester.py)
...
#### [NEW] [brain/src/brain/ranker.py](file:///home/himanshu/code/llmway/brain/src/brain/ranker.py)
...
#### [NEW] [brain/src/brain/selector.py](file:///home/himanshu/code/llmway/brain/src/brain/selector.py)
...
#### [NEW] [brain/src/brain/errors.py](file:///home/himanshu/code/llmway/brain/src/brain/errors.py)
