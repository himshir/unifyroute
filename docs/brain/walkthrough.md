...
Added `FireworksAdapter` in [adapters.py](file:///home/himanshu/code/llmway/router/src/router/adapters.py):
...
Updated [main.py](file:///home/himanshu/code/llmway/api-gateway/src/api_gateway/main.py):
...
| Module | Purpose |
|---|---|
| [config.py](file:///home/himanshu/code/llmway/brain/src/brain/config.py) | `BrainProviderEntry` dataclass + health URL registry for all providers |
| [health.py](file:///home/himanshu/code/llmway/brain/src/brain/health.py) | `check_endpoint()` + `check_provider_health()` — async HTTP health checks, all exceptions caught |
| [importer.py](file:///home/himanshu/code/llmway/brain/src/brain/importer.py) | `import_from_yaml_str()` / `import_from_json_str()` — idempotent bulk import |
| [tester.py](file:///home/himanshu/code/llmway/brain/src/brain/tester.py) | `test_all_brain_credentials()` — tests every brain credential, caches to Redis |
| [ranker.py](file:///home/himanshu/code/llmway/brain/src/brain/ranker.py) | `rank_brain_providers()` — multi-factor composite scoring |
| [selector.py](file:///home/himanshu/code/llmway/brain/src/brain/selector.py) | `select_for_brain()` — picks best healthy option |
| [errors.py](file:///home/himanshu/code/llmway/brain/src/brain/errors.py) | `brain_safe_message()` — maps exceptions to friendly strings |
...
7 new admin-only endpoints in [main.py](file:///home/himanshu/code/llmway/api-gateway/src/api_gateway/main.py):
...
[a9b8c7d6e5f4_add_brain_configs.py](file:///home/himanshu/code/llmway/migrations/versions/a9b8c7d6e5f4_add_brain_configs.py) creates:
```sql
...
`BrainConfig` SQLAlchemy model added to [shared/models.py](file:///home/himanshu/code/llmway/shared/src/shared/models.py)
...
Integration tests (`tests/test_brain_api.py`) require a running gateway and will run via `./run-tests.sh` after `./llmway start`.
...
```bash
# Run from llmway root with the gateway stopped
